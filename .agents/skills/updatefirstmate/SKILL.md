...
2. **Re-read AGENTS.md if your own instructions changed.**
   ...
   **Read `AGENTS.md` now** (CLAUDE.md and CODEBUDDY.md are real `@AGENTS.md` pointers to it) to refresh your operating instructions before doing anything else, so you are acting on the new instructions rather than the stale ones you were started with.
