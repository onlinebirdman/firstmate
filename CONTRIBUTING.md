...
- This repo is a template for running a firstmate orchestrator agent.
  [`AGENTS.md`](AGENTS.md) owns the supervisor contract, role boundary, and bundled firstmate skill triggers; `CLAUDE.md` and `CODEBUDDY.md` are real `@AGENTS.md` pointers to it, and `.claude/skills` is a symlink to `.agents/skills`.
...
@AGENTS.md
EOF
[ ! -L CODEBUDDY.md ] && cmp -s CODEBUDDY.md - <<'EOF'
